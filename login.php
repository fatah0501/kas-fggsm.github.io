...
<html>
  <head>
    <meta charset="UTF-8">
    <title>KAS FORMULASI | Log in</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-box-body">
       <div>
        <h1 style="text-align: center;"><b>KAS FGGSM</b></h1>
        </div><hr/>
        ...
        <!-- /.social-auth-links -->
    <hr/><center>
    <span style="text-align: center;">Powered By: <a href="http://https://fatahlensa.fatahlensa.repl.co/">Fatah Lensa</span>
  </div>
