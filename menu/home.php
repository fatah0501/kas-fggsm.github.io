...
<html>
  <head>
    <meta charset="UTF-8">
    <title>KAS FORMULASI | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="home.php" class="logo">
          ...
          <span class="logo-lg"><b>KAS FGGSM</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="../foto/mayora.jpg" class="user-image" alt="User Image"/>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="../foto/mayora.jpg" class="img-circle" alt="User Image" />
                    <p>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="callout callout-info">
            <h4>Announcement!!</h4>
            <p><b>Aplikasi Kas Formulasi Untuk Mempermudah Pendataan KAS Perbulannya !! </b><br>Developer: <a href="https://www.instagram.com/hasballah_f/" target="blank"> Fatah Lensa</a> | Powered By: <a href="https://fatahlensa.fatahlensa.repl.co/" target="blank">Fatah Lensa official</a></p>
          </div>
        </div>
        <!-- /.col -->
      </div>
        ...
        <div class="box-body">
          <dl>
            ...
            <dt>FUNGSI</dt>
                ...
                <dd>
                  <ol>
                    <li>Pembayaran Setiap Habis Gajian</li>
                    <li>Per bulan Minimal 10.000</li> 
                  </ol>
                   Info lebih lanjut mengenai aplikasi:
                    <ul>
                        <li><a href="https://api.whatsapp.com/send?phone=6289503515344" target="blank"><i class="fa fa-whatsapp"></i> : 089503515344</a></li>
                        <li><a href="mailto:hasbalahfatah0601@gmail.com"><i class="fa fa-envelope-o"></i> : hasbalahfatah0601@gmail.com</a></li>
                    </ul>
                    <p style="text-align: center">~<i> FGGSM </i><i class="fa fa-smile-o"></i>  ~</p>
                </dd>
            </dl>
        </div><!-- /.box-body -->
    </div><!-- /.box -->
    ...
    <!-- /.content -->
      ...
      <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
          <a href="https://fatahlensa.fatahlensa.repl.co/" target="blank">Fatah Lensa</a>
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2022 kas Formulasi.</strong> All rights reserved.
      </footer>
